...
/***/ "./modules/description/description.js":
/*!********************************************!*\
  !*** ./modules/description/description.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Description = /*#__PURE__*/function () {
  function Description() {
    ...
    _defineProperty(this, "btnInfoArr", document.querySelectorAll('.btn-info'));

    _defineProperty(this, "btnCloseArr", document.querySelectorAll('.description__btn-close'));

    _defineProperty(this, "idTimers", new Map());
  }

  _createClass(Description, [{
    key: "hideBtnInfo",
    value: function hideBtnInfo(e) {
    ...
    key: "showBtnInfo",
    value: function showBtnInfo(btnInfo) {
    ...
    value: function showDescription(e) {
      var idTimer = null;
      var description = e.target.nextElementSibling;
      var closeBtn = description.firstElementChild;
      description.classList.add('description_active');
      this.hideBtnInfo(e);
      idTimer = setTimeout(function () {
        var eventCloseButton = new Event('click');
    ...
    value: function closeDescription(e) {
      ...
      var description = closeBtn.closest('.description');
      var infoBtn = description.previousElementSibling;
      var idTimer = this.idTimers.get(closeBtn);
    ...
    value: function init() {
      ...
      this.btnInfoArr.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          _this.showDescription(e);
        });
      });
      this.btnCloseArr.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          _this.closeDescription(e);
        });
      });
    }
  }]);
...
var Slider3D = /*#__PURE__*/function () {
  ...
  _createClass(Slider3D, [{
    ...
    value: function setZIndex() {
      this.frames.forEach(function (item, i, arr) {
...
/***/ "./modules/description/description.scss":
/*!**********************************************!*\
  !*** ./modules/description/description.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modules_description_description_scss__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../modules/description/description.scss */ "./modules/description/description.scss");
/* harmony import */ var _modules_description_description__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../modules/description/description */ "./modules/description/description.js");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./common */ "./js/common.js");
...
slider3d.scroll = (0,_common__WEBPACK_IMPORTED_MODULE_22__.pauseDecorator)(slider3d.scroll, timePause);
slider3d.init();
var scrollBarTop = new _modules_scroll_bar_top_scroll_bar_top_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
scrollBarTop.scrollSlide = (0,_common__WEBPACK_IMPORTED_MODULE_22__.pauseDecorator)(scrollBarTop.scrollSlide, timePause);
scrollBarTop.init();
...
calculator.init();
var description = new _modules_description_description__WEBPACK_IMPORTED_MODULE_21__["default"]();
description.init();
})();
